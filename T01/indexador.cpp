...
int Indexador::getComparaIndice(Student *estudante1, Student *estudante2){
    // Matricula;
    if (this->index == 0) {
        if      (estudante1->getMatricula() < estudante2->getMatricula()) return -1;
        else                                                              return 1;
    }

    // Nome; Matricula;
    if (this->index == 1) {
        if      (estudante1->getNome() <  estudante2->getNome()) return -1;
    ...
    if (this->index == 2) {
        if      (estudante1->getSituacao() <  estudante2->getSituacao()) return -1;
    ...
    if (this->index == 3) {
        if      (estudante1->getMedia() >  estudante2->getMedia()) return -1;
